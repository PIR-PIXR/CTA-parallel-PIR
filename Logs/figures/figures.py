...
directory = "/Users/quangnhat/Desktop/Logs"
for h in h2:
...
plt.savefig("/Users/quangnhat/Desktop/Logs/figures/dbsize.pdf")
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/Users/quangnhat/Desktop/Logs/figures/mapsize.pdf")
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/Users/quangnhat/Desktop/Logs/figures/partitiontime.pdf")
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/Users/quangnhat/Desktop/Logs/figures/indexingtime.pdf")
...
axs[0, 0].plot(h2, server_color_reply_time_2, label="SEALPIR+Coloring (q=2)")
axs[0, 0].plot(h2, server_pbc_reply_time_2, label="SEALPIR+PBC (q=2)", linestyle='dashed')
axs[0, 0].legend()
axs[0, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[0, 1].plot(h16, server_color_reply_time_16, label="SEALPIR+Coloring (q=16)")
axs[0, 1].plot(h16, server_pbc_reply_time_16, label="SEALPIR+PBC (q=16)", linestyle='dashed')
axs[0, 1].legend()
axs[0, 1].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 0].plot(h128, server_color_reply_time_128, label="SEALPIR+Coloring (q=128)")
axs[1, 0].plot(h128, server_pbc_reply_time_128, label="SEALPIR+PBC (q=128)", linestyle='dashed')
axs[1, 0].legend()
axs[1, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 1].plot(h256, server_color_reply_time_256, label="SEALPIR+Coloring (q=256)")
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/Users/quangnhat/Desktop/Logs/figures/PIRservertime.pdf")
...
axs[0, 0].plot(h2, server_color_reply_size_2, label="SEALPIR+Coloring (q=2)")
axs[0, 0].plot(h2, server_pbc_reply_size_2, label="SEALPIR+PBC (q=2)", linestyle='dashed')
axs[0, 0].legend()
axs[0, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[0, 1].plot(h16, server_color_reply_size_16, label="SEALPIR+Coloring (q=16)")
axs[0, 1].plot(h16, server_pbc_reply_size_16, label="SEALPIR+PBC (q=16)", linestyle='dashed')
axs[0, 1].legend()
axs[0, 1].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 0].plot(h128, server_color_reply_size_128, label="SEALPIR+Coloring (q=128)")
axs[1, 0].plot(h128, server_pbc_reply_size_128, label="SEALPIR+PBC (q=128)", linestyle='dashed')
axs[1, 0].legend()
axs[1, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 1].plot(h256, server_color_reply_size_256, label="SEALPIR+Coloring (q=256)")
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/Users/quangnhat/Desktop/Logs/figures/PIRserverAnsSize.pdf")
...
axs[0, 0].plot(h2, client_color_query_size_2, label="SEALPIR+Coloring (q=2)")
axs[0, 0].plot(h2, client_pbc_query_size_2, label="SEALPIR+PBC (q=2)", linestyle='dashed')
axs[0, 0].legend()
axs[0, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[0, 1].plot(h16, client_color_query_size_16, label="SEALPIR+Coloring (q=16)")
axs[0, 1].plot(h16, client_pbc_query_size_16, label="SEALPIR+PBC (q=16)", linestyle='dashed')
axs[0, 1].legend()
axs[0, 1].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 0].plot(h128, client_color_query_size_128, label="SEALPIR+Coloring (q=128)")
axs[1, 0].plot(h128, client_pbc_query_size_128, label="SEALPIR+PBC (q=128)", linestyle='dashed')
axs[1, 0].legend()
axs[1, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 1].plot(h256, client_color_query_size_256, label="SEALPIR+Coloring (q=256)")
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/Users/quangnhat/Desktop/Logs/figures/PIRClientQuerySize.pdf")
...
axs[0, 0].plot(h2, client_color_query_time_2, label="SEALPIR+Coloring (q=2)")
axs[0, 0].plot(h2, client_pbc_query_time_2, label="SEALPIR+PBC (q=2)", linestyle='dashed')
axs[0, 0].legend()
axs[0, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[0, 1].plot(h16, client_color_query_time_16, label="SEALPIR+Coloring (q=16)")
axs[0, 1].plot(h16, client_pbc_query_time_16, label="SEALPIR+PBC (q=16)", linestyle='dashed')
axs[0, 1].legend()
axs[0, 1].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 0].plot(h128, client_color_query_time_128, label="SEALPIR+Coloring (q=128)")
axs[1, 0].plot(h128, client_pbc_query_time_128, label="SEALPIR+PBC (q=128)", linestyle='dashed')
axs[1, 0].legend()
axs[1, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 1].plot(h256, client_color_query_time_256, label="SEALPIR+Coloring (q=256)")
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/Users/quangnhat/Desktop/Logs/figures/PIRClientQueryTime.pdf")

# Plotting in subplots
fig, axs = plt.subplots(2, 2, figsize=(12, 8))
fig.suptitle("Total Client Decoded Costs", fontsize = 16)

axs[0, 0].plot(h2, client_color_extract_time_2, label="SEALPIR+Coloring (q=2)")
axs[0, 0].plot(h2, client_pbc_extract_time_2, label="SEALPIR+PBC (q=2)", linestyle='dashed')
axs[0, 0].legend()
axs[0, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[0, 1].plot(h16, client_color_extract_time_16, label="SEALPIR+Coloring (q=16)")
axs[0, 1].plot(h16, client_pbc_extract_time_16, label="SEALPIR+PBC (q=16)", linestyle='dashed')
axs[0, 1].legend()
axs[0, 1].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 0].plot(h128, client_color_extract_time_128, label="SEALPIR+Coloring (q=128)")
axs[1, 0].plot(h128, client_pbc_extract_time_128, label="SEALPIR+PBC (q=128)", linestyle='dashed')
axs[1, 0].legend()
axs[1, 0].xaxis.set_major_locator(MaxNLocator(integer=True))

axs[1, 1].plot(h256, client_color_extract_time_256, label="SEALPIR+Coloring (q=256)")
...
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig("/Users/quangnhat/Desktop/Logs/figures/PIRClientExtractTime.pdf")
